...
- [x] 03-02-PLAN.md — full UI-SPEC rendering: cards + inline CSS (light/dark/mobile) + XSS payload tests + html-validate gate
- [x] 03-03-PLAN.md — wire writeIndexHtml into pipeline, integration test asserting index.html lands in deploy commit, rebuild dist bundle
...
Plans:
- [ ] 04-01-PLAN.md — widget-injector module: getWidgetScriptTag pure helper + injectWidgetIntoHtmlFiles with marker idempotency, *.html-only filter, </body>/</html>/append fallback, full unit tests
