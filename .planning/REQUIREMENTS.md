...
- [x] **INDX-02**: Index page shows a timeline view of deployments with version name, date, and git ref
- [x] **INDX-03**: Index page displays per-version commit history (commits that went into each deployment)
- [x] **INDX-04**: Index page shows author information and commit metadata for each version
- [x] **INDX-05**: Index page has a modern, well-designed UI that works on desktop and mobile
...
- [x] **GHUB-05**: After deploying a PR preview, the Action posts a sticky comment on the PR with the preview URL
